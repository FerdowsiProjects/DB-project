...
# view 6
view-query = "CREATE VIEW view6_p AS SELECT DISTINCT course.course_name, avg(course.grade) FROM course GROUP BY cuorse.course_name ORDER BY AVG (course.grade) DESC"
mycursor.execute(view_query)
